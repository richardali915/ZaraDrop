...
<section class="login-shell">
  <Card>
    <h1>Admin Sign In</h1>
    <p>Authenticate to approve merchants, riders, and platform operations.</p>
    ...
    <form on:submit|preventDefault={handleSubmit}>
      <Input type="email" bind:value={email} label="Email" placeholder="admin@example.com" required />
