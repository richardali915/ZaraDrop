...
<section class="login-shell">
  <Card>
    ...
    <p>Sign in to manage store orders, inventory, and dispatch approvals.</p>
    ...
    <form on:submit|preventDefault={handleSubmit}>
      <Input type="email" bind:value={email} label="Email" placeholder="merchant@example.com" required />
