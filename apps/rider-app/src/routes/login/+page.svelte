<script lang="ts">
  ...
  import { Button, Input, Card } from '@zaradrop/ui';
...
<section class="login-shell">
  <Card>
    <h1>Rider Sign In</h1>
    <p>Sign in to manage ride availability, assignments, and dispatch readiness.</p>
    ...
    <form on:submit|preventDefault={handleSubmit}>
      <Input type="email" bind:value={email} label="Email" placeholder="rider@example.com" required />
